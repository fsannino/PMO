...
<form action="" method="post" name="frmRelatorioDetalhado" id="frmRelatorioDetalhado">
...
%>
	...
	<div align="center">
		<center>
  			<table border="0" width="90%" cellspacing="0" cellpadding="0" style="border: 1 solid #000000">
    			<tr>
      				<td bgcolor="#639ACE" style="border: 1 solid #000000" align="center">
						<font color="#FFFFFF" size="1" face="Georgia, Times New Roman, Times, serif">DESCRIÇÃO</font>
					</td>
    			</tr>
    			<tr>
      				<td style="border: 1 solid #000000" align="center">
						<%
						intQtdeColunas = 120 '169
						strDescricao = trim(rsRelatorios("Descricao"))
						intQtdeLinhas = RetornaQtdeLinhasTextArea(strDescricao, intQtdeColunas)
						%>
						<textarea name="txtDescricao" cols=<%=intQtdeColunas%> rows=<%=intQtdeLinhas%> readonly lang="pt" style="font-family: Arial, Helvetica, sans-serif; font-style: normal; font-size: xx-small;"><%=strDescricao%></textarea>
					</td>
    			</tr>
			    <tr>
    	  			<td bgcolor="#639ACE" style="border: 1 solid #000000" align="center">
						<font color="#FFFFFF" size="1" face="Georgia, Times New Roman, Times, serif">COMENTÁRIOS</font>
					</td>
			    </tr>
	    		<tr>
    	  			<td style="border: 1 solid #000000" align="center">
						<%
						strComentario = trim(rsRelatorios("Comments"))
						intQtdeLinhas = RetornaQtdeLinhasTextArea(strComentario, intQtdeColunas)
						%>
						<textarea name="txtComentario" cols=<%=intQtdeColunas%> rows=<%=intQtdeLinhas%> readonly lang="pt" style="font-family: Arial, Helvetica, sans-serif; font-style: normal; font-size: xx-small;"><%=strComentario%></textarea>
					</td>
    			</tr>
  			</table>
		</center>
	...
	<div align="center">
		<center>
	  		<table border="0" width="90%" style="border: 1 solid #000000" cellpadding="0" cellspacing="0">
    			<tr>
      				<td colspan="5" align="center" bgcolor="#639ACE" style="border: 1 solid #000000">
						<font color="#FFFFFF" size="1" face="Georgia, Times New Roman, Times, serif">TRACEABILIDADE</font>
					</td>
	    		</tr>
				<tr>
      				<td width="20%" align="center" bgcolor="#639ACE" style="border: 1 solid #000000">
						<font color="#FFFFFF" size="1" face="Georgia, Times New Roman, Times, serif">PROJETO</font>
					</td>
      				<td width="20%" align="center" bgcolor="#639ACE" style="border: 1 solid #000000">
						<font color="#FFFFFF" size="1" face="Georgia, Times New Roman, Times, serif">ID</font>
				...
				<%
				strSQL = "EXECUTE SP_RELATORIOS_TRACEABILITY " & _ 
						 "'" & rsRelatorios("Project_Code") & "', " & _
						 "'" & rsRelatorios("ID") & "', " & _
						 "'" & strAcesso & "'"
				
				set rsTraceability_Projeto = Server.CreateObject("ADODB.RecordSet")
				
				rsTraceability_Projeto.open strSQL, conConexao
				
				if not rsTraceability_Projeto.EOF then
					do while not rsTraceability_Projeto.EOF
						%>
						<tr>
    	  					<td width="20%" align="center" style="border: 1 solid #000000">
								<font face="Arial" size="1"><%=rsTraceability_Projeto("Desc_Projeto")%>&nbsp;</font>
							</td>
		      				<td width="20%" align="center" style="border: 1 solid #000000">
								<font face="Arial" size="1"><%=rsTraceability_Projeto("ID")%>&nbsp;</font>
							</td>
	      					<td width="20%" align="center" style="border: 1 solid #000000">
								<font face="Arial" size="1"><%=rsTraceability_Projeto("Nome")%>&nbsp;</font>
							</td>
	      					<td width="20%" align="center" style="border: 1 solid #000000">
								<font face="Arial" size="1"><%=rsTraceability_Projeto("Status")%>&nbsp;</font>
							</td>
	      					<td width="20%" align="center" style="border: 1 solid #000000">
								<font face="Arial" size="1">
								<%
								if (rsTraceability_Projeto("Data_Limite") <> cdate(0)) and (rsTraceability_Projeto("Data_Limite") <> cdate("01/01/1900")) then
									response.write rsTraceability_Projeto("Data_Limite")
								else
									response.write "&nbsp;"
								end if
								%>
						...
						<% 
						rsTraceability_Projeto.movenext
					loop
				else
					%>
					<tr>
				...
				rsTraceability_Projeto.close
				set rsTraceability_Projeto = nothing
				%>
	  		</table>
		</center>
	</div>

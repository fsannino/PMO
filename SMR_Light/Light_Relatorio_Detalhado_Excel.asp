		...
		<center>
			<table border="0" width="90%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="center">
						<font face="Arial" size="1">DESCRIÇÃO</font>
					</td>
   		  			<td align="center">
						<font face="Arial" size="1">COMENTÁRIOS</font>
					</td>
   					<td align="center">
						<font face="Arial" size="1">RASTREABILIDADE</font>
					</td>
				</tr>
	<%
	...
	%>
				<tr>
					...
					<%End If%>
   					...
   					<td align="left">
						<font face="Arial" size="1"><%=trim(rsRelatorios("Descricao"))%></font>
					</td>
    	  			<td align="left">
						<font face="Arial" size="1"><%=trim(rsRelatorios("Comments"))%></font>
					</td>
					<%
					...
					if not rsTraceability_Projeto.EOF then
						...
						do while not rsTraceability_Projeto.EOF
								...
								strTraceability = rsTraceability_Projeto("Desc_Projeto") & " - " & _
												  rsTraceability_Projeto("ID") & " - " & _
												  rsTraceability_Projeto("Nome") & " - " & _
												  rsTraceability_Projeto("Status") & " - "
								
								if (rsTraceability_Projeto("Data_Limite") <> cdate(0)) and (rsTraceability_Projeto("Data_Limite") <> cdate("01/01/1900")) then
									strTraceability = strTraceability & rsTraceability_Projeto("Data_Limite")
								else
									strTraceability = strTraceability & " "
								end if
								
								if not isnull(rsTraceability_Projeto("Nome_Funcionario")) then
									strTraceability = strTraceability & " - " &  rsTraceability_Projeto("Nome_Funcionario")
								else
									strTraceability = strTraceability & " - "
								end if
								
								strTraceability = strTraceability & chr(13) & chr(10)
					...
					%>
    	  			<td align="left">
						<font face="Arial" size="1"><%=strTraceability%></font>
					</td>
					<%

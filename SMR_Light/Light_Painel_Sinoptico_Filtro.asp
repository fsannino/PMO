				...
				<tr>
			    	...
			    	<td align="right" bgcolor=#6699cc>
						...
						<font color="#666666" size="1" face="Georgia, Times New Roman, Times, serif">
						    <select size="1" name="slcProjeto" style="WIDTH:300px;" onchange="Selfrente();">
						        <option value="" <%If strProj = "" Then%>Selected<%End If%>></option>
			  	...
			  	<tr>
			    	<td bgcolor=#6699cc align="right">
						<b>
						<!--<font color="#000000" size="1" face="Arial">-->
						<font color=White size="1" face="Georgia, Times New Roman, Times, serif">Criticidade:</font>
						</b>
					</td>
			    	<td align="right" bgcolor=#6699cc>
						<!--<font size="1" face="Arial">-->
						<font color="#666666" size="1" face="Georgia, Times New Roman, Times, serif">
						    <select size="1" name="slcOpcao" style="WIDTH:300px;">
						        ...
						        <option value="1" <%If Trim(strOpcao) = "1" Then%>Selected<%End If%>>BAIXO</option>
						        <option value="2" <%If Trim(strOpcao) = "2" Then%>Selected<%End If%>>MEDIO</option>
						        <option value="3" <%If Trim(strOpcao) = "3" Then%>Selected<%End If%>>ALTO</option>
						        <option value="4" <%If Trim(strOpcao) = "4" Then%>Selected<%End If%>>CRITICO</option>
						    </select>
						</font>
					</td>
			  	</tr>
...
function Selfrente()
{
	document.frmPainel_Sinoptico_Filtro.action = "Light_Painel_Sinoptico_Filtro.asp";
...
function Redefinir()
{
	...
	document.frmPainel_Sinoptico_Filtro.slcProjeto.value = "";
	document.frmPainel_Sinoptico_Filtro.slcFrente.value = "";
	document.frmPainel_Sinoptico_Filtro.slcEquipe.value = "";
	document.frmPainel_Sinoptico_Filtro.slcResponsavel.value = "";
	document.frmPainel_Sinoptico_Filtro.slcOpcao.value = "";

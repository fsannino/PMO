	...
	<%If Not rs.EOF Then%>
		...
		<table style="border-style: solid; border-width: 1" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr height="17" style="height:12.75pt">
		    ...
		    <td class="xl27" width="50px" style="border: 1 solid #666666" align="center" bgcolor=#6699cc><b>
				<font color=White size="1" face="Georgia, Times New Roman, Times, serif">Coment.</font></b></td>
		...
		<%Do While Not rs.EOF%>
			...
			<%Else%>
					...
					<td class="xl30" align="right" style="border: 1 solid #666666" width="75px">
						<font face="Arial" size="1">
							<input type="hidden" id="hidDuracao" name="hidDuracao" value="<%=rs("DURACAO")%>">
							<%=rs("DURACAO")%>&nbsp;
						</font>
					</td>
					  ...
					  <td class="xl23" align="right" style="border: 1 solid #666666" width="40px">
						...
						<td class="xl30" align=center style="border: 1 solid #666666" width="50px">
							<font face="Arial" size="1">
								<a href="JavaScript:abreJanelaComentario('Light_Comentario.asp?strProjeto=<%=rs("PROJ_ID")%>&strUID=<%=rs("TASK_UID")%>')">
									<img src="icones/ro.gif" alt="Comentários" name="Comentarios" border="0">
								</a>
							</font>
						</td>
...
function ValidaComplete(num)
{
	...
	if (intCont == 0)
	{
		...
		var Duracao = document.frmMedicao_Detalhe_LIGHT.hidDuracao.value
	...
	*/	
	...
	else
	{
		...
		var Duracao = document.frmMedicao_Detalhe_LIGHT.hidDuracao(num).value

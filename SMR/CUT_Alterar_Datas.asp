...
End Function
	...
	if strOperacao <> "" Then
			...
			With cmdResultado
			    ...
			    .CommandType = 4
				.CommandTimeout = 600
			    .CommandText = "SP_INCLUIR_LOG_ALTERACAO_TAREFAS"
			    
			    .Parameters.Refresh
				.Parameters(1).Value = strLogin
				.Parameters(2).Value = strProjeto
				.Parameters(3).Value = strUID
				.Parameters(4).Value = strDataIni
				.Parameters(5).Value = strDataFim
				.Parameters(6).Value = strMotivo
	...
	Else
		...
		strSql = "SP_LISTAR_LOG_TAREFAS_ALTERADAS " & strProjeto & ", " & strUID & " "
...
<form name="frmAlterarDatas" ID="frmAlterarDatas" action="CUT_Alterar_Datas.asp" method="post">
<%if trim(strOperacao) = "" Then%>
	...
	<table style="border-style: solid; border-width: 1" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <%If Not rs1.EOF Then%>
		...
		<tr height="17" style="height:12.75pt">
		  <td class="xl27" style="border: 1 solid #666666" align="center" bgcolor=#6699cc colspan=4>
			<b>
				<font color=White size="2" face="Georgia, Times New Roman, Times, serif">
					Alterações Solicitadas Anteriomente
				</font>
			</b>
		  </td>	
		</tr>
		...
		<%Do While Not rs1.EOF%>
			...
			<tr height="17" style="height:12.75pt">
			  <td class="xl28" style="border: 1 solid #666666" width="80px" align="center" >
			  	<font face="Arial" size="1">
			  		<%=FormatDateTime(rs1("DataInicio"),2)%>&nbsp;
			  	</font>
			  </td>
			  <td class="xl28" style="border: 1 solid #666666" width="80px" align="center" >
			  	<font face="Arial" size="1">
			  		<%=FormatDateTime(rs1("DataFim"),2)%>&nbsp;
			  	</font>
			  </td>
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="0">
		<tr>
			<td height="17" class="xl27" width=150px style="border: 1 solid #666666" align="center" bgcolor=#6699cc>
				<font color=White size="1" face="Georgia, Times New Roman, Times, serif">
					Motivo da Alteração:&nbsp;&nbsp;
				</font>
			</td>
			<td class="xl30" align="right" style="border: 1 solid #666666" width=400px>
				<font face="Arial, Times New Roman, Times, serif">
					<input id="txtMotivo" name="txtMotivo" value="" size=73  maxlength=255>
				</font>
			</td>
		</tr>
	</table>
...
function Validar()
{
	...
	{
		if (document.frmAlterarDatas.txtMotivo.value == "")
		{
			erro = erro + "Motivo da alteração obrigatório."
		}
	}
	if (erro != "") 
	{
...
function ValidaDatas(conteudoAux, Tipo)
{
	...
	{
		msg_erro = "O campo "+titulo+" é obrigatório.";
		bol = true;
	}

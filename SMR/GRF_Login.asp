		...
		if rs.EOF Then
			...
			if rs("Senha") <> strSenha Then
				...
				If Trim(strOrigem) = "" Then 
					strOrigem = "./GRF_Medicao_Filtro.asp"
				Else
...
<tr bgcolor=#6699cc>
	<th>
	<font color=White size="1" face="Georgia, Times New Roman, Times, serif">&nbsp;Informe seus dados para entrar no Medição...</font>
	</th>
</tr>
<tr>
	<td>
...
function Confirmar()
{
	document.frmLogin.action = "GRF_Login.asp";

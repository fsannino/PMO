...
<!--				<TD  width=20%></TD>-->
		...
		<table>
			<TR>
				<TD  width=43%>&nbsp;</TD>
				<TD  align=center>
					<b><font color="#666666" size="2" face="Georgia, Times New Roman, Times, serif">
						<img src="img_Saneamento/smile_large.jpg" width="25" height="30" border="0">
						&nbsp;Obrigado por realizar a medição!!!&nbsp;&nbsp;Volte sempre!!!&nbsp;
						<img src="img_Saneamento/smile_large.jpg" width="25" height="30" border="0">
					</font></b>
				</TD>
			</TR>

...
intTotalGeral = 0
    ...
    With cmdResultado
        ...
        .CommandType = 4
		.CommandTimeout = 480
        .CommandText = "SP_LISTAR_SCORECARD_USUARIO_RISKS"
	...
	<table width="100%" border="0">
		<tr>
			...
			<td width="40%" align="center" height="10px">
				<p><b><font size="3" face="Georgia, Times New Roman, Times, serif" color="#666666">Riscos por Usuário</font></b></p>
			</td>
			<td width="30%" height="10px">&nbsp;</td>
		</tr>
	</table>
			  ...
			  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right>
					<font face="Arial" size="1">
						<%If cint(rs("NoPrazo")) = 0 Then%>
							0&nbsp;
						<%Else%>
							<a href="JavaScript:abreJanelaRelRisks('PMO_Relatorio_Risks_Detalhado.asp?strUsuario=<%=rs("Ret_Usuario")%>&strData=<%=rs1("Data_Score")%>&strTipo=A')">
								<%=rs("NoPrazo")%>&nbsp;
							</a>
						<%End If%>
					</font>
			  ...
			  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right>
					<font face="Arial" size="1">
						<%If cint(rs("Atras10")) = 0 Then%>
							0&nbsp;
						<%Else%>
							<a href="JavaScript:abreJanelaRelRisks('PMO_Relatorio_Risks_Detalhado.asp?strUsuario=<%=rs("Ret_Usuario")%>&strData=<%=rs1("Data_Score")%>&strTipo=AT10')">
				   				<%=rs("Atras10")%>&nbsp;
							</a>
						<%End If%>
			  ...
			  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right>
					<font face="Arial" size="1">
						<%If cint(rs("AtrasM10")) = 0 Then%>
							0&nbsp;
						<%Else%>
							<a href="JavaScript:abreJanelaRelRisks('PMO_Relatorio_Risks_Detalhado.asp?strUsuario=<%=rs("Ret_Usuario")%>&strData=<%=rs1("Data_Score")%>&strTipo=ATM10')">
			   					<%=rs("AtrasM10")%>&nbsp;
							</a>
						<%End If%>
			   		</font>

...
'********************************************************************************
    ...
    With cmdResultado
        ...
        .CommandType = 4
		.CommandTimeout = 600
        .CommandText = "SP_INCLUIR_PAINEL_SINOPTICO_CUTOVER_TB_TEMP"
...
'*********************************************************************************
    ...
    With cmdResultado
        ...
        .CommandType = 4
		.CommandTimeout = 600
        .CommandText = "SP_LISTAR_PAINEL_SINOPTICO_CUTOVER"
	...
	<table width="100%" border="0">
		<tr>
			...
			<td width="30%" align="middle">
				<p><b>
				<font color="#666666" size="3" face="Georgia, Times New Roman, Times, serif">Painel Sinóptico Entrada em Produção</font>
				</b></p>
			</td>
			<td width="30%">&nbsp;</td>
		</tr>

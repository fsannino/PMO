	...
	<%If Not rs.EOF Then%>
		...
		<table style="border-style: solid; border-width: 1" border="0" cellspacing="0" cellpadding="0" align=center>
		  ...
		  <tr height="17" style="height:12.75pt" >
				...
				<td class="xl27" width="100px" style="border: 1 solid #666666" align="center" bgcolor=#6699cc nowrap><b>
					<font color=White size="1" face="Georgia, Times New Roman, Times, serif">Não Definido</font></b></td>
		...
		<%Do While Not rs.EOF%>
			...
			<%  Set cmdResultado = Server.CreateObject("ADODB.Command")
				...
				With cmdResultado
				    ...
				    .CommandType = 4
					.CommandTimeout = 480
				    .CommandText = "SP_LISTAR_CRITICIDADE_BAIXO"
				...
				With cmdResultado
				    ...
				    .CommandType = 4
					.CommandTimeout = 480
				    .CommandText = "SP_LISTAR_CRITICIDADE_MODERADO"
				...
				With cmdResultado
				    ...
				    .CommandType = 4
					.CommandTimeout = 480
				    .CommandText = "SP_LISTAR_CRITICIDADE_ALTO"
				...
				With cmdResultado
				    ...
				    .CommandType = 4
					.CommandTimeout = 480
				    .CommandText = "SP_LISTAR_CRITICIDADE_CRITICO"
				...
				With cmdResultado
				    ...
				    .CommandType = 4
					.CommandTimeout = 480
				    .CommandText = "SP_LISTAR_CRITICIDADE_NAO_DEFINIDO"
			...
			<tr height="17" style="height:12.75pt" >
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs1("Andamento")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=A&strCriticidade=Baixo')">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs2("Andamento")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=A&strCriticidade=Moderado')">
						...
						<%Else%>
							<%If intCont = 0 Then%>		
								<%If cint(rs3("Andamento")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=A&strCriticidade=Alto')">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs4("Andamento")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=A&strCriticidade=Critico')">
			  ...
			  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right>
					<font face="Arial" size="1">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs5("Andamento")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=A&strCriticidade=--Nao Definido--')">
										<%TotalNaoDefinido = TotalNaoDefinido + cint(rs5("Andamento"))%>
										<%=rs5("Andamento")%>
									</a>
								<%End IF%>
							<%Else%>
			...
			<tr height="17" style="height:12.75pt" >
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs1("Atrasadas10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=AT10&strCriticidade=Baixo')">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs2("Atrasadas10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=AT10&strCriticidade=Moderado')">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs3("Atrasadas10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=AT10&strCriticidade=Alto')">
						...
						<%Else%>
							<%If intCont = 0 Then%>
 								<%If cint(rs4("Atrasadas10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=AT10&strCriticidade=Critico')">
			  ...
			  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right>
					<font face="Arial" size="1">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs5("Atrasadas10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=AT10&strCriticidade=--Nao Definido--')">
										<%TotalNaoDefinido = TotalNaoDefinido + cint(rs5("Atrasadas10"))%>
										<%=rs5("Atrasadas10")%>
									</a>
								<%End IF%>
							<%Else%>
			...
			<tr height="17" style="height:12.75pt" >
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs1("AtrasadasMais10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=ATM10&strCriticidade=Baixo')">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs2("AtrasadasMais10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=ATM10&strCriticidade=Moderado')">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs3("AtrasadasMais10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=ATM10&strCriticidade=Alto')">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs4("AtrasadasMais10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=ATM10&strCriticidade=Critico')">
			  ...
			  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right>
					<font face="Arial" size="1">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<%If cint(rs5("AtrasadasMais10")) = 0 Then%>
									0&nbsp;
								<%Else%>
									<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strTipo=ATM10&strCriticidade=--Nao Definido--')">
										<%TotalNaoDefinido = TotalNaoDefinido + cint(rs5("AtrasadasMais10"))%>							
										<%=rs5("AtrasadasMais10")%>
									</a>
								<%End IF%>
							<%Else%>
				...
				If (rs("Data_Score") <> StrData) Then%>
					...
					<table cellspacing="0" cellpadding="0" align=center>
						<tr height="17" style="height:12.75pt" >
						  ...
						  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right bgcolor=#ff7372>
								<font face="Arial" size="1">
									...
									<%Else%>
										<%If intCont = 0 Then%>
											<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Criticidade_Comite_Filtro.asp?strEquipe=<%=strEquipe%>&strData=<%=rs("Data_Score")%>&strCarteira=C1&strComite=<%=strComite%>')">
						   					<%=TotalCarteira1%>
											</a>
										<%Else%>
						   					<%=TotalCarteira1%>
						...
						<tr height="17" style="height:12.75pt" >
						  ...
						  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right bgcolor=Yellow>
								<font face="Arial" size="1">
									...
									<%Else%>
										<%If intCont = 0 Then%>
											<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Criticidade_Comite_Filtro.asp?strEquipe=<%=strEquipe%>&strData=<%=StrData%>&strCarteira=C2&strComite=<%=strComite%>')">
											<%=TotalCarteira2%>
											</a>
										<%Else%>
											<%=TotalCarteira2%>
						...
						<tr height="17" style="height:12.75pt" >
						  ...
						  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right bgcolor=YellowGreen>
								<font face="Arial" size="1">
									...
									<%Else%>
										<%If intCont = 0 Then%>
											<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Criticidade_Comite_Filtro.asp?strEquipe=<%=strEquipe%>&strData=<%=StrData%>&strCarteira=C3&strComite=<%=strComite%>')">
											<%=TotalCarteira3%>
											</a>
										<%Else%>
											<%=TotalCarteira3%>
						...
						<tr height="17" style="height:12.75pt" >
						  ...
						  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right>
								<font face="Arial" size="1">
									<%If TotalNaoDefinido = 0 Then%>
										0&nbsp;
									<%Else%>
										<%If intCont = 0 Then%>
											<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Criticidade_Comite_Filtro.asp?strEquipe=<%=strEquipe%>&strData=<%=StrData%>&strCarteira=ND&strComite=<%=strComite%>')">
											<%=TotalNaoDefinido%>
											</a>
										<%Else%>
											<%=TotalNaoDefinido%>
						...
						<tr height="17" style="height:12.75pt" >
						  ...
						  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right>
								<font face="Arial" size="1">
									<%If intCont = 0 Then%>
										<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Issues_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=StrData%>&strTipo=Todos')">
			...
			<tr height="17" style="height:12.75pt" >
			  ...
			  <td class="xl28" style="border: 1 solid #666666" width="100px" nowrap align=right bgcolor=#ff7372>
					<font face="Arial" size="1">
						...
						<%Else%>
							<%If intCont = 0 Then%>
								<a href="JavaScript:abreJanelaRelIssues('PMO_Relatorio_Criticidade_Comite_Filtro.asp?strEquipe=<%=strEquipe%>&strData=<%=StrData%>&strCarteira=C1&strComite=<%=strComite%>')">
								<%=TotalCarteira1%>
								</a>
							<%Else%>
								<%=TotalCarteira1%>							
		...
		<%If intCont = 0 Then%>
			...
			<table cellspacing="0" cellpadding="0" align=center>
				<tr align=center>
					...
					<td>&nbsp;</td>
					<td align=center><a href="JavaScript:abreJanelaRelIssues('PMO_Tab_Av_Critic_Issue.asp')" align="center"><font color="#666666" size="1" face="Georgia, Times New Roman, Times, serif">Legenda</font></a></td>
					<td></td>

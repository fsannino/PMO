...
function Confirmar()
{
	document.frmRelatorio_Criticidade_Detalhe.action = "PMO_Relatorio_Risks_Detalhado.asp?strEquipe=<%=strEquipe%>&strData=<%=strData%>&strTipo=<%=strTipo%>&strCriticidade=<%=strCriticidade%>&strComite=" + document.frmRelatorio_Criticidade_Detalhe.cboComite.value + "&strCarteira=<%=strCarteira%>";

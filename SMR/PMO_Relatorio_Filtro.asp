...
<head>
	...
	function RedirecionaPaginaRelatorio()
	{
		...
		{
			document.frmFiltroRelatorio.hidAction.value = "PMO_Relatorio_Consolidado"
		}
		else
		{
			document.frmFiltroRelatorio.hidAction.value = "PMO_Relatorio_Detalhado";
		}
	}
	...
	function btnRedefinir_onclick()
	{
		...
		document.frmFiltroRelatorio.action = 'PMO_Relatorio_Filtro.asp?pCaminho=Relatórios';
...
if trim(strFiltro) <> "" then
	if trim(strConsolidadoSelecionado) <> "" then%>
		<input type="hidden" name="hidAction" id="hidAction" value="PMO_Relatorio_Consolidado">
	<%else%>
		<input type="hidden" name="hidAction" id="hidAction" value="PMO_Relatorio_Detalhado">
	<%end if
else%>
	<input type="hidden" name="hidAction" id="hidAction" value="PMO_Relatorio_Consolidado">
<%end if%>

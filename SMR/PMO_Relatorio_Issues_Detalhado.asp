...
If Trim(strUsuario) = "" Then
	...
	If trim(strCarteira) <> "" Then
		...
		With cmdResultado
		    ...
		    .CommandType = 4
			.CommandTimeout = 600
		    .CommandText = "SP_LISTAR_ISSUES_DETALHE_CARTEIRA"
	...
	Else
		...
		With cmdResultado
		    ...
		    .CommandType = 4
			.CommandTimeout = 600
		    .CommandText = "SP_LISTAR_ISSUES_DETALHE"
...
Else
	...
	With cmdResultado
	    ...
	    .CommandType = 4
		.CommandTimeout = 600
	    .CommandText = "SP_LISTAR_ISSUES_DETALHE_USUARIO"
...
if not rsRelatorios.EOF then
	...
	do while not rsRelatorios.EOF 
		...
		If (rsRelatorios("Criticidade_Impacto") = "Baixo" and strTipo = "No prazo") or _
		   (rsRelatorios("Criticidade_Impacto") = "Baixo" and strTipo = "Atrasados (menos de 10 dias)") or _
		   (rsRelatorios("Criticidade_Impacto") = "Moderado" and strTipo = "No prazo") Then
			strCarteira = "Nivel 3"
		End If
		If (rsRelatorios("Criticidade_Impacto") = "Baixo" and strTipo = "Atrasados (mais de 10 dias)") or _
		   (rsRelatorios("Criticidade_Impacto") = "Moderado" and strTipo = "Atrasados (menos de 10 dias)") or _
		   (rsRelatorios("Criticidade_Impacto") = "Moderado" and strTipo = "Atrasados (mais de 10 dias)") or _
		   (rsRelatorios("Criticidade_Impacto") = "Alto" and strTipo = "No prazo") or _
		   (rsRelatorios("Criticidade_Impacto") = "Alto" and strTipo = "Atrasados (menos de 10 dias)") Then
			strCarteira = "Nivel 2"
		End If
		If (rsRelatorios("Criticidade_Impacto") = "Alto" and strTipo = "Atrasados (mais de 10 dias)") or _
		   (rsRelatorios("Criticidade_Impacto") = "Critico" and strTipo = "No prazo") or _
		   (rsRelatorios("Criticidade_Impacto") = "Critico" and strTipo = "Atrasados (menos de 10 dias)") or _
		   (rsRelatorios("Criticidade_Impacto") = "Critico" and strTipo = "Atrasados (mais de 10 dias)") Then
			strCarteira = "Nivel 1"
		End If
			...
			<table border="0" width="90%" cellspacing="0" cellpadding="0" style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid">
    			...
    			<tr>
	      			<td width="12%" style="BORDER-RIGHT: 1px solid; BORDER-TOP: 0px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid" bgcolor="#ffffff" height="15">
						<font face="Arial" size="1">&nbsp;CRITICIDADE:</font></td>
      				<td width="33%" style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 0px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid" bgcolor="#ffffff" height="15">
						<font face="Arial" size="1">&nbsp;<%=rsRelatorios("Criticidade_Impacto")%></td>
      				<td width="12%" style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 0px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid" bgcolor="#ffffff" height="15">
						<font face="Arial" size="1">&nbsp;TIPO CRITICIDADE: </font></td>
      				<td width="33%" style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 0px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid" bgcolor="#ffffff" height="15">
						<font face="Arial" size="1">&nbsp;<%=rsRelatorios("Tipo_Impacto")%></td>
    			</tr>
    			<tr>
      				<td width="12%" align="left" bgcolor="#ffffff" style="BORDER-RIGHT: 1px solid; BORDER-TOP: 0px solid; BORDER-LEFT: 1px solid; BORDER-BOTTOM: 1px solid" height="15">

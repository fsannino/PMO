...
'		response.Redirect("./LOGIN.ASP?hidOrigem=./GVI_Medicao_Detalhe.asp")
		Response.Redirect ("./Erro.asp?Erro=Sua sessão expirou. Por-favor, logue-se novamente.&Voltar=true&IrPara=./LOGIN.ASP?hidOrigem=./PMO_Medicao_Detalhe.asp")
	...
	if strOperacao <> "" Then
		...
		response.Redirect("./PMO_Confirmacao_Medicao.asp?strUsuario=" & strUsuario & "&strPagina=PMO_Medicao_Detalhe.asp")
...
'*********************************************************************************
	...
	<FORM name="frmMedicao_Detalhe_PMO" id="frmMedicao_Detalhe_PMO" action="PMO_Medicao_Detalhe.asp" method="post">
...
{
	var intCont	= (document.frmMedicao_Detalhe_PMO.hidCont.value - 1)

	if (intCont == 0)
	{

		var conteudo = document.frmMedicao_Detalhe_PMO.txtComplete.value
		var DtFim = document.frmMedicao_Detalhe_PMO.hiddtFinish.value
		var DtInicio = document.frmMedicao_Detalhe_PMO.hiddtStart.value
		var TpLogin = document.frmMedicao_Detalhe_PMO.hidTpLogin.value

		if (jTrim(conteudo) == "")
		{
			alert("O conteúdo do campo %Comp invalido. deve ser numérico.");
			document.frmMedicao_Detalhe_PMO.txtComplete.value = document.frmMedicao_Detalhe_PMO.hidComplete(num).value;
			document.frmMedicao_Detalhe_PMO.txtComplete.focus();
			return false;
		}

		if (parseInt(conteudo) < parseInt(document.frmMedicao_Detalhe_PMO.hidComplete.value))
		{
			alert("O conteúdo do campo %Comp invalido. deve ser maior que o atual.");
			document.frmMedicao_Detalhe_PMO.txtComplete.value = document.frmMedicao_Detalhe_PMO.hidComplete.value;
			document.frmMedicao_Detalhe_PMO.txtComplete.focus();
			return false;
		}

	/*	if (parseInt(conteudo) != parseInt(document.frmMedicao_Detalhe_PMO.hidComplete(num).value))
		{
			if ((TpLogin == 'P') && (conteudo > 50))
			{
				alert("O conteúdo do campo %Comp invalido para o usuário. deve ser menor ou igual a 50.");
				document.frmMedicao_Detalhe_PMO.txtComplete(num).value = document.frmMedicao_Detalhe_PMO.hidComplete(num).value;
				document.frmMedicao_Detalhe_PMO.txtComplete(num).focus();
				return false;
			}

			if ((TpLogin == 'S') && (parseInt(document.frmMedicao_Detalhe_PMO.hidComplete(num).value) < 50))
			{
	...
	*/	
		if (parseInt(document.frmMedicao_Detalhe_PMO.hidProj.value)!= 8)
		{
			if (DtInicio == DtFim)
			{ 
	...
	{
		var conteudo = document.frmMedicao_Detalhe_PMO.txtComplete(num).value
		var DtFim = document.frmMedicao_Detalhe_PMO.hiddtFinish(num).value
		var DtInicio = document.frmMedicao_Detalhe_PMO.hiddtStart(num).value
		var TpLogin = document.frmMedicao_Detalhe_PMO.hidTpLogin(num).value
	...
	*/	
		if (parseInt(document.frmMedicao_Detalhe_PMO.hidProj(num).value)!= 8)
		{
			if (DtInicio == DtFim)
			{ 
				if ((conteudo != 0) && (conteudo != 100))
...
function Confirmar()
{
	...
	document.frmMedicao_Detalhe_PMO.style.cursor = "wait";
			
	document.frmMedicao_Detalhe_PMO.hidDados.value = "";
	document.frmMedicao_Detalhe_PMO.hidOperacao.value = "";
	
	if (intCont == 0)
	{
		for(var i = 0; i <= intCont;i++)
		{
			if (document.frmMedicao_Detalhe_PMO.txtComplete.value != document.frmMedicao_Detalhe_PMO.hidComplete.value)
			{
				if (strAux == "")
				{
					strAux = document.frmMedicao_Detalhe_PMO.hidProj.value + "|" + document.frmMedicao_Detalhe_PMO.hidId.value + "|" + document.frmMedicao_Detalhe_PMO.hidUid.value + "|" + document.frmMedicao_Detalhe_PMO.txtComplete.value;
				}	
				else
				{
					strAux = strAux + ";" + document.frmMedicao_Detalhe_PMO.hidProj.value + "|" + document.frmMedicao_Detalhe_PMO.hidId.value + "|" + document.frmMedicao_Detalhe_PMO.hidUid.value + "|" + document.frmMedicao_Detalhe_PMO.txtComplete.value;
				}
			}
		}
	}
	else
	{
		for(var i = 0; i <= intCont;i++)
		{
			if (document.frmMedicao_Detalhe_PMO.txtComplete(i).value != document.frmMedicao_Detalhe_PMO.hidComplete(i).value)
			{
				if (strAux == "")
				{
					strAux = document.frmMedicao_Detalhe_PMO.hidProj(i).value + "|" + document.frmMedicao_Detalhe_PMO.hidId(i).value+ "|" + document.frmMedicao_Detalhe_PMO.hidUid(i).value + "|" + document.frmMedicao_Detalhe_PMO.txtComplete(i).value;
				}	
				else
				{
					strAux = strAux + ";" + document.frmMedicao_Detalhe_PMO.hidProj(i).value + "|" + document.frmMedicao_Detalhe_PMO.hidId(i).value + "|" + document.frmMedicao_Detalhe_PMO.hidUid(i).value + "|" + document.frmMedicao_Detalhe_PMO.txtComplete(i).value;
				}
			}
		}
	}
	...
	if (strAux != "")
	{
		document.frmMedicao_Detalhe_PMO.hidDados.value = strAux;
		document.frmMedicao_Detalhe_PMO.hidOperacao.value = 'A';
		document.frmMedicao_Detalhe_PMO.style.cursor = "";
		document.frmMedicao_Detalhe_PMO.submit();
	}
	else
	{

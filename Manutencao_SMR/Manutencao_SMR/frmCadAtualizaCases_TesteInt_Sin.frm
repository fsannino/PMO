...
Begin VB.Form frmCadAtualizaCases_TesteInt_Sin 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Cadastro de Atualizações de Tarefas Cases Teste Integrado para SMR"
   ClientHeight    =   5160
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12675
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaCases_TesteInt_Sin.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaCases_TesteInt_Sin.frx":0112
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaCases_TesteInt_Sin.frx":0224
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaCases_TesteInt_Sin.frx":038E
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaCases_TesteInt_Sin.frx":04A0
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaCases_TesteInt_Sin.frx":08F2
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "frmCadAtualizaCases_TesteInt_Sin"
...
Private Sub mIncluirAtulTarTIN_SMR()
    ...
    strSQL = "EXECUTE SP_LISTAR_ATUALIZA_CASES_TESTEINT_SIN " & strCodProjOrg & ", " & strCodTarOrg & ", " & strCodProjDes & ", " & strCodTarDes
    ...
    If rsAtualizaTarExiste.RecordCount = 0 Then
        ...
        strSQL = "SP_INCLUIR_ATUALIZA_CASES_TIN_SMR " & strCodProjOrg & ", " & strCodTarOrg & ", " & strCodProjDes & ", " & strCodTarDes
...
Private Sub mExcluirAtulTarTIN_SMR()
    ...
    strSQL = "SP_EXCLUIR_ATUALIZA_CASES_TIN_SMR " & strCodProjOrg & ", " & strCodTarOrg & ", " & strCodProjDes & ", " & strCodTarDes
...
Private Sub mPreencheListaAtulTarTIN_SMR()
    ...
    With lvwCadastroAtulTarTIN_SMR
        ...
        strSQL = "EXECUTE SP_LISTAR_ATUALIZA_CASES_TESTEINT_SIN"

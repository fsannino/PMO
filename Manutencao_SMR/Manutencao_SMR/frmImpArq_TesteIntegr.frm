...
Begin VB.Form frmImpArq_TesteIntegr 
   Caption         =   "Importação do Arquivo Teste Integrado"
   ClientHeight    =   2115
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6060
   Icon            =   "frmImpArq_TesteIntegr.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2115
   ...
   End
End
Attribute VB_Name = "frmImpArq_TesteIntegr"
...
On Error GoTo ErrImportarArq
        ...
        strArqSaida = Mid(strArquivo, 1, InStrRev(strArquivo, "\")) & "Inc_TI_" & Format(Year(Now()), "0000") & Format(Month(Now()), "00") & Format(Day(Now()), "00")
        ...
        For intLinha = 2 To intTotal
            ...
            strTransacao = wrkSheetDados.Cells(intLinha, 5).Value
            strCenario = wrkSheetDados.Cells(intLinha, 6).Value
            ...
            If Trim(intCod_Proj) <> "" And Trim(intUID) <> "" Then
                ...
                If Not rs.EOF Then
                    ...
                    If intCompleteza < rs("TASK_PCT_COMP") Then
                        ...
                        strSQL = "EXEC SP_ATUALIZAR_TESTE_INTEGRADO " & intCod_Proj & ", " & intUID & ", " & intCompleteza & ", '" & strStatus & "', '" & strTransacao & "', '" & strCenario & "' "

...
Begin VB.Form frmAtualizarPerc_TesteCampo_Sin 
   Caption         =   "Atualização dos % Teste Campo -> Sinergia"
   ClientHeight    =   1650
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6060
   Icon            =   "frmAtualizarPerc_TesteCampo_Sin.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1650
   ...
   End
End
Attribute VB_Name = "frmAtualizarPerc_TesteCampo_Sin"
...
Private Sub cmdOK_Click()
    ...
    If Atualizar_Perc_TesteCampo_Sin() Then
        MsgBox "Atualização dos % Teste Campo -> Sinergia gerada com sucesso.", vbInformation + vbOKOnly, "Atualização dos % Teste Campo -> Sinergia"
    Else
        MsgBox "Erro na Atualização dos % Teste Campo -> Sinergia.", vbCritical + vbOKOnly, "Atualização dos % Teste Campo -> Sinergia"
    End If
...
Private Function Atualizar_Perc_TesteCampo_Sin() As Boolean
...
On Error GoTo ErrAtualizar_Perc_TesteCampo_Sin

        fraAtualizacaoTar.Caption = "Atualização dos % Teste Campo -> Sinergia"
        
        Atualizar_Perc_TesteCampo_Sin = False
        
        Screen.MousePointer = vbHourglass
        
        strArqSaida = "C:\Inc_AP_TCP_SIN_" & Format(Year(Now()), "0000") & Format(Month(Now()), "00") & Format(Day(Now()), "00")
        ...
        wrkSheetDados.Cells(1, 1).Value = "Projeto Origem TCP"
        wrkSheetDados.Cells(1, 2).Value = "UID Origem TCP"
        wrkSheetDados.Cells(1, 3).Value = "Tarefa Origem TCP"
        wrkSheetDados.Cells(1, 4).Value = "%Complete Origem TCP"
        ...
        strSQL = "SP_LISTAR_ATUALIZA_PERC_TCP_SMR "
        ...
        Do While Not rs1.EOF
            ...
            rs2.Open strSQL, dbConexaoTCP, adOpenStatic, adLockReadOnly, adCmdText
                ...
                If Not rs3.EOF Then
                    ...
                    If rs2("TASK_PCT_COMP") >= rs3("TASK_PCT_COMP") Then
                        ...
                        With cmdAtualizar
                            ...
                            .CommandType = 4
                            .CommandTimeout = 1200
                            .CommandText = "SP_ATUALIZAR_TAREFAS"
                            
                            .Parameters.Refresh
                            .Parameters(1).Value = rs3("PROJ_ID")
                            .Parameters(2).Value = rs3("TASK_ID")
                            .Parameters(3).Value = rs3("TASK_UID")
        ...
        Atualizar_Perc_TesteCampo_Sin = True
        
        Exit Function
        
ErrAtualizar_Perc_TesteCampo_Sin:

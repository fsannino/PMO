...
Begin VB.Form frmCadAtualizaPercDt_TesteInt_Sin 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Cadastro de Atualizações de Tarefas % Datas Teste Integrado para SMR"
   ClientHeight    =   5160
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   12675
   ...
   Begin MSComctlLib.Toolbar tlbCadastroAtulTarTIN_SMR 
      Align           =   1  'Align Top
      Height          =   420
      Left            =   0
      TabIndex        =   0
      ...
      EndProperty
   End
   Begin VB.Frame fraListaCadAtulTarTIN_SMR 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaPercDt_TesteInt_Sin.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaPercDt_TesteInt_Sin.frx":0112
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaPercDt_TesteInt_Sin.frx":0224
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaPercDt_TesteInt_Sin.frx":038E
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaPercDt_TesteInt_Sin.frx":04A0
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmCadAtualizaPercDt_TesteInt_Sin.frx":08F2
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin MSComctlLib.ListView lvwCadastroAtulTarTIN_SMR 
         Height          =   4185
         Left            =   45
         TabIndex        =   8
         Top             =   255
      ...
      End
   End
   Begin VB.Frame fraDadosCadAtulTarTIN_SMR 
   ...
   End
End
Attribute VB_Name = "frmCadAtualizaPercDt_TesteInt_Sin"
...
Private Sub mHabilitarBotoesToolBarAtulTarTIN_SMR()

    With tlbCadastroAtulTarTIN_SMR
...
Private Sub mDesabilitarBotoesToolBarAtulTarTIN_SMR()
...
Private Function mValidarCamposAtulTarTIN_SMR() As Boolean

    On Error GoTo ErrmValidarCamposAtulTarTIN_SMR
    ...
    If Trim(cmbProjetoOrg.Text) = "" Then
        ...
        mValidarCamposAtulTarTIN_SMR = False
        Exit Function
    End If
    ...
    mValidarCamposAtulTarTIN_SMR = True
        
    Exit Function
    
ErrmValidarCamposAtulTarTIN_SMR:

    MsgBox "Ocorreu o seguinte erro na rotina mValidarCamposAtulTarTIN_SMR: " & vbCrLf & _
...
Private Sub mIncluirAtulTarTIN_SMR()

    Dim strSQL                       As String
    Dim lngLinhasAfetadas            As Long
    Dim itmAtulTarTIN_SMRInserido As ListItem
    ...
    On Error GoTo ErrmIncluirAtulTarTIN_SMR
    ...
    strSQL = "EXECUTE SP_LISTAR_ATUALIZA_PERCDT_TESTEINT_SIN " & strCodProjOrg & ", " & strCodTarOrg & ", " & strCodProjDes & ", " & strCodTarDes

    Set rsAtualizaTarExiste = New ADODB.Recordset
    rsAtualizaTarExiste.CursorLocation = adUseClient
    rsAtualizaTarExiste.Open strSQL, dbConexaoTIN, adOpenStatic, adLockReadOnly, adCmdText


    If rsAtualizaTarExiste.RecordCount = 0 Then

        strSQL = "SP_INCLUIR_ATUALIZA_PERCDT_TIN_SMR " & strCodProjOrg & ", " & strCodTarOrg & ", " & strCodProjDes & ", " & strCodTarDes

        dbConexaoTIN.Execute strSQL, lngLinhasAfetadas
        ...
        fraDadosCadAtulTarTIN_SMR.Visible = False
        fraListaCadAtulTarTIN_SMR.Visible = True

        Call mPreencheListaAtulTarTIN_SMR
...
ErrmIncluirAtulTarTIN_SMR:

    Screen.MousePointer = vbNormal
    
    MsgBox "Ocorreu o seguinte erro na rotina mIncluirAtulTarTIN_SMR: " & vbCrLf & _
           "Erro: " & Err.Number & vbCrLf & _
           "Descrição: " & Err.Description, _
           vbCritical + vbOKOnly, _
           App.Title
...
Private Sub mExcluirAtulTarTIN_SMR()
    ...
    On Error GoTo ErrmExcluirAtulTarTIN_SMR
    
    Screen.MousePointer = vbHourglass
        
    strCodProjOrg = lvwCadastroAtulTarTIN_SMR.SelectedItem.Text
    strCodTarOrg = lvwCadastroAtulTarTIN_SMR.SelectedItem.SubItems(5)
    strCodProjDes = lvwCadastroAtulTarTIN_SMR.SelectedItem.SubItems(6)
    strCodTarDes = lvwCadastroAtulTarTIN_SMR.SelectedItem.SubItems(7)
        
    strSQL = "SP_EXCLUIR_ATUALIZA_PERCDT_TIN_SMR " & strCodProjOrg & ", " & strCodTarOrg & ", " & strCodProjDes & ", " & strCodTarDes
...
ErrmExcluirAtulTarTIN_SMR:

    Screen.MousePointer = vbNormal
    
    MsgBox "Ocorreu o seguinte erro na rotina mExcluirAtulTarTIN_SMR: " & vbCrLf & _
           "Erro: " & Err.Number & vbCrLf & _
           "Descrição: " & Err.Description, _
           vbCritical + vbOKOnly, _
           App.Title
...
Private Sub mTratarTelaIncluirAtulTarTIN_SMR()

    On Error GoTo ErrmTratarTelaIncluirAtulTarTIN_SMR
    
    'Desabilita os botões da ToolBar
    Call mDesabilitarBotoesToolBarAtulTarTIN_SMR
    
    'Coloca o frame que contém os dados sobreposto ao frame de lista
    fraDadosCadAtulTarTIN_SMR.Visible = True
    fraListaCadAtulTarTIN_SMR.Visible = False
    
    Call mLimparDadosAtulTarTIN_SMR
    
    Exit Sub
    
ErrmTratarTelaIncluirAtulTarTIN_SMR:

    MsgBox "Ocorreu o seguinte erro na rotina mTratarTelaIncluirAtulTarTIN_SMR: " & vbCrLf & _
           "Erro: " & Err.Number & vbCrLf & _
           "Descrição: " & Err.Description, _
           vbCritical + vbOKOnly, _
           App.Title
...
Private Sub mTratarTelaExcluirAtulTarTIN_SMR()

    On Error GoTo ErrmTratarTelaExcluirAtulTarTIN_SMR
...
ErrmTratarTelaExcluirAtulTarTIN_SMR:

    MsgBox "Ocorreu o seguinte erro na rotina mTratarTelaExcluirAtulTarTIN_SMR: " & vbCrLf & _
           "Erro: " & Err.Number & vbCrLf & _
           "Descrição: " & Err.Description, _
           vbCritical + vbOKOnly, _
           App.Title
...
Private Sub mPreencheListaAtulTarTIN_SMR()

    Dim rsAtulTarTIN_SMR    As ADODB.Recordset
    Dim itmAtulTarTIN_SMR   As ListItem
    Dim strSQL              As String
    
    On Error GoTo ErrmPreencheListaAtulTarTIN_SMR
    
    Screen.MousePointer = vbHourglass
    
    With lvwCadastroAtulTarTIN_SMR
    
        .ListItems.Clear
        .ColumnHeaders.Clear
    
        'Monta o cabeçalho da lista
        Call mMontaCabecalhoListaAtulTarTIN_SMR
        
        strSQL = "EXECUTE SP_LISTAR_ATUALIZA_PERCDT_TESTEINT_SIN"
        
        Set rsAtulTarTIN_SMR = New ADODB.Recordset
        rsAtulTarTIN_SMR.Open strSQL, dbConexaoTIN, adOpenStatic, adLockReadOnly, adCmdText
        
        Do While Not rsAtulTarTIN_SMR.EOF
        
            Set itmAtulTarTIN_SMR = .ListItems.Add(, , rsAtulTarTIN_SMR.Fields("Cod_Proj_Orig").Value)
            itmAtulTarTIN_SMR.SubItems(1) = rsAtulTarTIN_SMR.Fields("Proj_Org").Value
            itmAtulTarTIN_SMR.SubItems(2) = rsAtulTarTIN_SMR.Fields("Tar_Org").Value
            itmAtulTarTIN_SMR.SubItems(3) = rsAtulTarTIN_SMR.Fields("Proj_Des").Value
            itmAtulTarTIN_SMR.SubItems(4) = rsAtulTarTIN_SMR.Fields("Tar_Des").Value
            itmAtulTarTIN_SMR.SubItems(5) = rsAtulTarTIN_SMR.Fields("Cod_UID_Orig").Value
            itmAtulTarTIN_SMR.SubItems(6) = rsAtulTarTIN_SMR.Fields("Cod_Proj_Dest").Value
            itmAtulTarTIN_SMR.SubItems(7) = rsAtulTarTIN_SMR.Fields("Cod_UID_Dest").Value
              
            rsAtulTarTIN_SMR.MoveNext
            
        Loop
    
    End With
    
    rsAtulTarTIN_SMR.Close
    Set rsAtulTarTIN_SMR = Nothing
    
    Screen.MousePointer = vbNormal
    
    Exit Sub
    
ErrmPreencheListaAtulTarTIN_SMR:

    Screen.MousePointer = vbNormal
    
    MsgBox "Ocorreu o seguinte erro na rotina mPreencheListaAtulTarTIN_SMR: " & vbCrLf & _
           "Erro: " & Err.Number & vbCrLf & _
           "Descrição: " & Err.Description, _
           vbCritical + vbOKOnly, _
           App.Title
           
    If rsAtulTarTIN_SMR.State = adStateOpen Then
        rsAtulTarTIN_SMR.Close
        Set rsAtulTarTIN_SMR = Nothing
    End If
...
Private Sub mMontaCabecalhoListaAtulTarTIN_SMR()
...
Private Sub cmdCancelar_Click()
    ...
    Call mHabilitarBotoesToolBarAtulTarTIN_SMR
...
Private Sub cmdGravar_Click()
    ...
    If mValidarCamposAtulTarTIN_SMR() Then
            
        'Inclusao
        Call mIncluirAtulTarTIN_SMR
...
Private Sub lvwCadastroAtulTarTIN_SMR_ColumnClick(ByVal ColumnHeader As MSComctlLib.ColumnHeader)
...
Private Sub tlbCadastroAtulTarTIN_SMR_ButtonClick(ByVal Button As MSComctlLib.Button)

    Select Case Button.Index
    
        Case 1 'Incluir
        
            Call mTratarTelaIncluirAtulTarTIN_SMR
                        
        Case 3 'Excluir
        
            If MsgBox("Deseja realmente excluir este registro ?", vbQuestion + vbYesNo, App.Title) = vbYes Then
                Call mExcluirAtulTarTIN_SMR
            End If
...
Private Sub mPreencherComboProjetos()
    ...
    rsProjetosOrg.Open strSQL, dbConexaoTIN, adOpenStatic, adLockReadOnly, adCmdText
...
Private Sub mPreencherComboTarefasOrg(strCodProjeto As String)
    ...
    rsTarefas.Open strSQL, dbConexaoTIN, adOpenStatic, adLockReadOnly, adCmdText
...
Private Sub mLimparDadosAtulTarTIN_SMR()
